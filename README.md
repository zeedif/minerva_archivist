...
- **Keeps what you do.** Naming a language or a region gives you that set; a
  wishlist and an achievements filter each name their own, and say whether they
  add to each other or narrow each other.
